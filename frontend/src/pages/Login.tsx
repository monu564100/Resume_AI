          ...
          <Card variant="glassDark" className="p-8">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold mb-2">
                <span className="text-primary text-glow-primary">Welcome</span>{' '}
                Back
              </h1>
              <p className="text-gray-400">
                Login to access your resume analysis dashboard
              </p>
            </div>
              ...
              <div className="space-y-4 mb-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="password" id="password" value={password} onChange={e => setPassword(e.target.value)} className="bg-dark-50 border border-gray-700 text-white rounded-lg block w-full pl-10 pr-3 py-2.5 focus:ring-primary focus:border-primary" placeholder="••••••••" required />
                  </div>
                </div>
              </div>
